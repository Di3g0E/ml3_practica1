...
try:
    ...
    print(f"Error: No se pudo importar LinearAutoencoder desde src.models.linear_autoencoder")
    print(f"Asegúrate de que la estructura de carpetas es correcta.")
    print(f"Detalle del error: {e}")
    sys.exit(1)

# Función de prueba para LinearAutoencoder con el df de entrenamiento cargado
def test_linear_autoencoder_model(train_df):
    """
    Prueba el funcionamiento básico de LinearAutoencoder.
    """
    ...
    ae = MixedManifoldDetector(model_type='linear_autoencoder', epochs=test_epochs, batch_size=test_batch_size, lr=lr, error_threshold=error_threshold)
    ...
    print("Test de LinearAutoencoder pasado correctamente.\n")
