...
try:
    ...
    print(f"Error: No se pudo importar LinearSparseAutoencoder desde src.models.linear_sparse_autoencoder")
    print(f"Asegúrate de que la estructura de carpetas es correcta.")
    print(f"Detalle del error: {e}")
    sys.exit(1)

# Función de prueba para LinearSparseAutoencoder con el df de entrenamiento cargado
def test_linear_sparse_autoencoder_model(train_df):
    """
    Prueba el funcionamiento básico de LinearSparseAutoencoder.
    """
    ...
    ae = MixedManifoldDetector(model_type='linear_sparse_autoencoder', epochs=test_epochs, batch_size=test_batch_size, lr=lr, error_threshold=error_threshold, sparsity_weight=1e-3)
    ...
    print("Test de LinearSparseAutoencoder pasado correctamente.\n")
